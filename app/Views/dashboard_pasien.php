                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat Datang <?= $pasien['nama_pasien']?></li>
                        </ol>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $kunjungan['catatan_medis']?></td>
                                            <td><?= $kunjungan['resep_obat']?></td>
                                            <td><?= $kunjungan['validasi_kunjungan']?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
