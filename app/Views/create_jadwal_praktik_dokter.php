            ...
            <form action="<?=base_url('/dokter/jadwal/create')?>" method="POST">
                ...
                <div class="mb-3 row">
                    <label for="jam_mulai" class="col-sm-2 col-for m-label">Jam Mulai</label>
                        <div class="col-sm-4">
                            <input type="time" class="form-control <?= session('validation') && session('validation')->hasError('jam_mulai') ? 'is-invalid' : '' ?>" name="jam_mulai" required value="<?= old('jam_mulai')?>" >
                ...
                <div class="mb-3 row">
                    <label for="jam_selesai" class="col-sm-2 col-for m-label">Jam Selesai</label>
                        <div class="col-sm-4">
                            <input type="time" class="form-control <?= session('validation') && session('validation')->hasError('jam_selesai') ? 'is-invalid' : '' ?>" name="jam_selesai" required value="<?= old('jam_selesai')?>">
                ...
                <div class="mb-3 row">
                    <label for="lokasi" class="col-sm-2 col-for m-label">Lokasi</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control <?= session('validation') && session('validation')->hasError('lokasi') ? 'is-invalid' : '' ?>" name="lokasi" required value="<?= old('lokasi')?>">
