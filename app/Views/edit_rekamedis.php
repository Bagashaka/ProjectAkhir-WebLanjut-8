        ...
        <div class="card-body">
            ...
            <form action="<?=base_url('/dokter/rekamedis/'.$medis['id'])?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control <?= session('validation') && session('validation')->hasError('keluhan') ? 'is-invalid' : '' ?>" name="keluhan"  value="<?=$medis['keluhan'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control <?= session('validation') && session('validation')->hasError('diagnosa') ? 'is-invalid' : '' ?>" name="diagnosa"  value="<?= $medis['diagnosa'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control  <?= session('validation') && session('validation')->hasError('resep_obat') ? 'is-invalid' : '' ?>" name="resep_obat"  value="<?= $medis['resep_obat'] ?>">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control  <?= session('validation') && session('validation')->hasError('tanggal_pemeriksaan') ? 'is-invalid' : '' ?>" name="tanggal_pemeriksaan"  value="<?= $medis['tanggal_pemeriksaan'] ?>">
