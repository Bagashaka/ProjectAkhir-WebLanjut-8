...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'umur_admin'       => ['type' => 'int', 'constraint' => 3],
            'alamat_admin'     => ['type' => 'varchar', 'constraint' => 255],
            'nama_pasien'       => ['type' => 'varchar', 'constraint' => 255],
            'alamat_pasien'     => ['type' => 'varchar', 'constraint' => 255],
            'tanggal_lahir'     =>['type'     => 'DATE', ],
            'nomor_kontak'      => ['type'=> 'VARCHAR','constraint'=> 14,],
            'validasi'          => ['type'=> 'BOOL','default'=> false,],
            'nama_dokter'       => ['type' => 'varchar', 'constraint' => 255],
            'spesialisasi'      =>['type'  =>'VARCHAR','constraint'=>255,], 
